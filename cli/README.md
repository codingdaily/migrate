...
[Release Downloads](https://github.com/codingdaily/migrate/releases)

```
$ curl -L https://github.com/codingdaily/migrate/releases/download/$version/migrate.$platform-amd64.tar.gz | tar xvz
```
...
```
$ curl -L https://packagecloud.io/codingdaily/migrate/gpgkey | apt-key add -
$ echo "deb https://packagecloud.io/codingdaily/migrate/ubuntu/ xenial main" > /etc/apt/sources.list.d/migrate.list
$ apt-get update
...
```
$ go get -u -d github.com/codingdaily/migrate/cli
$ cd $GOPATH/src/github.com/codingdaily/migrate/cli
$ dep ensure
$ go build -tags 'postgres' -o /usr/local/bin/migrate github.com/codingdaily/migrate/cli
```
...
1. Support for build constraints will be removed in the future: https://github.com/codingdaily/migrate/issues/60
